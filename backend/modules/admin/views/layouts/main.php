                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => 'Modules', 'icon'=>'glyphicon glyphicon-th', 'url'=>'index.php?r=settings/auth-item'],
                            ['label' => 'Assignrights', 'icon'=>'glyphicon glyphicon-th', 'url'=>'index.php?r=settings/auth-assignment'],
                        ],
                    ],
                ],
            ]);  ?>
