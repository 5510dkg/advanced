...
/**
 * This is the model class for table "agency_address".
 *
 * @property integer $id
 ...
 */
class AgencyAddress extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'agency_id','h_no', 'street_address', 'p_office', 'district_id', 'state_id', 'pincode', 'country_id'], 'required'],
