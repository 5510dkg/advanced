...
class Agency extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'email', 'landline_no','agency_type','mobile_no', 'mail_house_no', 'mail_street_address', 'mail_p_office','add_pincode', 'mail_country_id', 'mail_state_id', 'mail_district_id', 'mail_pincode','commission','agency_type','route_id'], 'required'],
