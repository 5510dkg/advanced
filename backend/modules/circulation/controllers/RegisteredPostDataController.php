...
use backend\modules\circulation\models\RegisteredPostDataSearch;
 ...
 */
class RegisteredPostDataController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all RegisteredPostData models.
     * @return mixed
     */
    ...
    /**
     * Displays a single RegisteredPostData model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RegisteredPostData model.
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new RegisteredPostData",
                  ...
                  return [
                    ...
                    'title'=> "Create new RegisteredPostData",
                    'content'=>'<span class="text-success">Create RegisteredPostData success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update RegisteredPostData #".$id,
    ...
    /**
     * Delete an existing RegisteredPostData model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RegisteredPostData model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = RegisteredPostData::findOne($id)) !== null) {
            return $model;
        } else {
