...
use backend\modules\settings\models\DesignationSearch;
...
class DesignationController extends Controller
{
    ...
    {
        $countBranches = Designation::find()
                ->where(['department_id' => $id])
                ->count();
 
        $branches = Designation::find()
                ->where(['department_id' => $id])
                ->all();
        ...
        if($countBranches > 0 )
        {
            foreach($branches as $branch ){
                echo "<option value='".$branch->id."'>".$branch->designation_name."</option>";
            }
        }
        else{
            echo "<option> - </option>";
