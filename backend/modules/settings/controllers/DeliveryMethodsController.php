...
use backend\modules\settings\models\DeliveryMethodsSearch;
...
class DeliveryMethodsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new DeliveryMethods",
                ...
                return [
                    ...
                    'title'=> "Create new DeliveryMethods",
                    'content'=>'<span class="text-success">Create DeliveryMethods success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update DeliveryMethods #".$id,
    ...
    /**
     * Delete an existing DeliveryMethods model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing DeliveryMethods model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
