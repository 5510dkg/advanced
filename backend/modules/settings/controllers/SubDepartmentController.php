...
use Yii;
use backend\modules\settings\models\SubDepartment;
use backend\modules\settings\models\SubDepartmentSearch;
...
class SubDepartmentController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new SubDepartment",
                ...
                return [
                    ...
                    'title'=> "Create new SubDepartment",
                    'content'=>'<span class="text-success">Create SubDepartment success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing SubDepartment model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing SubDepartment model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
