...
<!--                <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="index.php?r=site/changepassword"><i class="fa fa-user fa-fw"></i> Change Password</a>
                        </li>
                        
                        <li class="divider"></li>
                        <li>
                            <?= Html::a('<i class="fa fa-sign-out fa-fw"></i> Logout', ['/site/logout'], ['data-method'=>'post']) ?>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
